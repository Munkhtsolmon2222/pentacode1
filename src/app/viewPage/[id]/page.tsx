...
export default function ViewPageExplore() {
  ...
  const handleDonation = async () => {
    ...
    setButtonClicked(true); // trigger donation complete state
    setIsClicked(false); // reset after donation completion
  };
  return (
            ...
            >
              {userData?.backgroundImage ? (
                <div className="flex absolute right-10 top-4">
                  ...
                  >
                    {/* You can add content inside the label if needed */}
                  </label>
                </div>
              ) : (
                <div
                ...
                {isClicked ? (
                  <button
                    ...
                    onClick={async () => {
                      ...
                      setButtonClicked(true); // Set the buttonClicked to true after donation is successful
                    }}
                    className="w-full p-2 bg-[#18181B] text-white rounded-md font-md hover:bg-[#18181B]"
                  >
                    Support

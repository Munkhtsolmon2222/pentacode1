          ...
          <div className="gap-3 border rounded-md p-4">
            <div className="flex justify-between border-b-[1px] pb-6 mt-4">
              ...
              <button
                ...
                className=" rounded-sm bg-[#F4F4F5] p-2 text-md"
              >
                Edit page
              </button>
            ...
            <div className="mt-10 ml-4">
              ...
              <p className="w-full my-6 text-md">{userData?.about}</p>
            </div>
          </div>
        ...
        <div className="w-[40%] h-[60%] p-6 bg-[#ffffff] border rounded-md">
          <div className="mb-4">
            ...
            <div className=" flex gap-4 mt-4 text-sm">
              <button className="p-2 bg-[#F4F4F5] rounded-md text-[#18181B] text-md flex justify-center items-center gap-2">
                <FiCoffee /> $1
              </button>
          ...
          <div className="mb-7">
            ...
            <input
              className="w-full border rounded-md p-2 mt-4 outline-none text-md "
          ...
          <div className="mb-10">
            ...
            <textarea
              className="w-full border rounded-md px-4 py-2 mt-4 outline-none text-md "
